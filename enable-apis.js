...
rl.question('Would you like to open the Google Cloud Console now? (yes/no): ', async (answer) => {
  if (answer.toLowerCase() === 'yes') {
    console.log('\nOpening Google Cloud Console...');
    try {
      await open('https://console.cloud.google.com/apis/library?project=bhookmukt');
      console.log('Google Cloud Console opened in your browser.');
    } catch (error) {
      console.error('Error opening browser:', error);
      console.log('Please manually open: https://console.cloud.google.com/apis/library?project=bhookmukt');
    }
  }

  rl.question('\nHave you enabled all the required APIs? (yes/no): ', (enabled) => {
